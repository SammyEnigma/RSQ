...
speed()
{
	self iPrintln( "^2You Have Super Speed" );
	iPrintlnBold("^3" + self.name + " ^2Enabled Super Speed ");
...
speed0ff()
{
	...
	iPrintlnBold("^3" + self.name + " ^1Disabled speed now. ");
}
...
partymode()
{
	...
	//for(;;)
	{
		iPrintlnBold("^3" + self.name + " ^1Enabled Party ");
		players = getEntArray( "player", "classname" );
		for(k = 0; k < players.size; k++)
			players[k] setClientDvar("r_fog", 1);
		iPrintlnBold("^2PARTY ^1TIME");
