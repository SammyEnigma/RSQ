main()
{
	...
	setDvar( "sv_hostname", "^5RS^7' Promod ^5TDM^7/^5SD" );
	...
	setDvar( "scr_war_timelimit", 7.5 ); // [0->] (minutes)
	...
	setDvar( "logfile", 0 );
	setDvar( "g_log", "promod_tdm.log" );
	setDvar( "g_logSync", 1 );
	setDvar( "sv_log_damage", 1);
	...
	// website
	setDvar( "promod_hud_website", "^0clan-rs.co.uk ^7|| ^8Admin XF: ^1ksxusman" ); // (avoid "//" here)
