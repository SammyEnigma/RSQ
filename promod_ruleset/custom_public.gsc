main()
{
	...
	setDvar( "scr_sd_roundlimit", 12 ); // [0->] (points)
	...
	// class limits
	setDvar( "class_assault_limit", 8 );
	setDvar( "class_specops_limit", 8 );
	...
	setDvar( "sv_maxPing", 999 );
	setDvar( "sv_minPing", 0 );
	setDvar( "sv_reconnectlimit", 10 );
	...
	// website
	setDvar( "promod_hud_website", "^2WWW.CLAN-RS.CO.UK" ); // (avoid "//" here)
	...
	setDvar( "promod_mc_message_1", "^3VISIT US ^2WWW.CLAN-RS.CO.UK" );
	setDvar( "promod_mc_message_2", "^2WELCOME TO ^1|RS|^2PROMODLIVE" );
